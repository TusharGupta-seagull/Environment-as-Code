...
output "security_group_name" {
  ...
  value       = var.create_sg ? aws_security_group.main[0].name : null
}

output "security_group_vpc_id" {
  description = "VPC ID of the security group"
  value       = var.create_sg ? aws_security_group.main[0].vpc_id : null
}

output "security_group_owner_id" {
  description = "Owner ID of the security group"
  value       = var.create_sg ? aws_security_group.main[0].owner_id : null
}
